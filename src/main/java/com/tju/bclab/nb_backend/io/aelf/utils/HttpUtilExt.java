...
public class HttpUtilExt {
   ...
   */
  public static String sendDelete(String reqUrl, String decodeCharset, String version, String authBasic) {
    logger.debug("Request address:" + reqUrl);
    if (StringUtil.isBlank(version)) {
      version = "";
    } else {
    ...
    String chainContext = ClientUtil
        .sendDelete(reqUrl, decodeCharset, "application/json" + version, authBasic);
    logger.debug("Return parameters:" + chainContext);
    return chainContext;
  }
